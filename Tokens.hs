...
alex_table = listArray (0 :: Int, 5714)
  [ 0
  , 13
  , 13
  , 13
...
alex_check = listArray (0 :: Int, 5714)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_21 = \p -> \s -> TokenSeq p
alex_action_22 = \p -> \s -> TokenAnd p
alex_action_23 = \p -> \s -> TokenOr p
alex_action_24 = \p -> \s -> TokenNot p
alex_action_25 = \p -> \s -> TokenDivEq p
alex_action_26 = \p -> \s -> TokenTimesEq p
alex_action_27 = \p -> \s -> TokenSubEq p
alex_action_28 = \p -> \s -> TokenPlusEq p
alex_action_29 = \p -> \s -> TokenInc p
alex_action_30 = \p -> \s -> TokenDec p
alex_action_31 = \p -> \s -> TokenMinus p
alex_action_32 = \p -> \s -> TokenPlus p
alex_action_33 = \p -> \s -> TokenTimes p
alex_action_34 = \p -> \s -> TokenDiv p
alex_action_35 = \p -> \s -> TokenEq p
alex_action_36 = \p -> \s -> TokenGt p
alex_action_37 = \p -> \s -> TokenLt p
alex_action_38 = \p -> \s -> TokenIf p
alex_action_39 = \p -> \s -> TokenThen p
alex_action_40 = \p -> \s -> TokenElse p
alex_action_41 = \p -> \s -> TokenContinue p
alex_action_42 = \p -> \s -> TokenEnd p
alex_action_43 = \p -> \s -> TokenFor p
alex_action_44 = \p -> \s -> TokenInt p (read s)
